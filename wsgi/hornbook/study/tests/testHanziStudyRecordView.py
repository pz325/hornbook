...
class HanziStudyRecordViewSetTests(APITestCase):
    ...
    def test_list(self):
        ...
        # act
        url = reverse('hanzistudyrecord-list') + '?category_id={category_id}'.format(category=self.category.id)
        response = self.client.get(url, format='json')
    ...
    #     # arrange
    #     util.create_one_leitner_record(self.user, self.category.name, u'东', 'C')
    #     util.create_one_leitner_record(self.user, self.category.name, u'南', '1')
    #     util.create_one_leitner_record(self.user, self.category.name, u'西', '3')
    ...
    #         util.create_one_leitner_record(self.user, self.category.name, h, 'R')
    #     util.create_one_HanziStudyCount_instance(self.user, self.category, 1)
    ...
    #     util.create_one_leitner_record(self.user, self.category.name, u'东', 'C')
    #     util.create_one_leitner_record(self.user, self.category.name, u'南', '1')
    #     util.create_one_leitner_record(self.user, self.category.name, u'西', '2')
    #     for h in retired_hanzis:
    #         util.create_one_leitner_record(self.user, self.category.name, h, 'R')
    #     util.create_one_HanziStudyCount_instance(self.user, self.category, 1)
    ...
    #     # arrange
    #     util.create_one_leitner_record(self.user, self.category.name, u'东', 'C')
    #     util.create_one_leitner_record(self.user, self.category.name, u'北', 'C')
    #     count = 12
    ...
    #     # arrange
    #     util.create_one_leitner_record(self.user, self.category.name, u'东', '2')
    #     util.create_one_leitner_record(self.user, self.category.name, u'北', 'C')
    #     count = 12
    #     util.create_one_HanziStudyCount_instance(self.user, self.category, count)  # irrelate setting
    ...
    #     # arrange
    #     util.create_one_leitner_record(self.user, self.category.name, u'东', 'R')
    #     util.create_one_leitner_record(self.user, self.category.name, u'北', 'C')
    #     count = 12
    #     util.create_one_HanziStudyCount_instance(self.user, self.category, count)  # irrelate setting
    ...
    #     # arrange
    #     util.create_one_leitner_record(self.user, self.category.name, u'东', '3')
    #     util.create_one_leitner_record(self.user, self.category.name, u'北', 'R')
    #     count = 12
